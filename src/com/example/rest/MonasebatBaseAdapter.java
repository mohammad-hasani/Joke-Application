...
public class MonasebatBaseAdapter extends BaseAdapter {
	private Context c;
	private LayoutInflater inf;
	private String[] dataBody, dataPublisher;
	public MonasebatBaseAdapter(Context c, String[] dataBody, String[] dataPublisher)
	{
		this.c = c;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		// TODO Auto-generated method stub
		if(convertView == null)
			convertView = inf.inflate(R.layout.monasebat_list_items, parent, false);
