...
public class MoredDashtimBaseAdapter extends BaseAdapter {
	private Context c;
	private LayoutInflater inf;
	private String[] dataBody, dataPublisher;
	public MoredDashtimBaseAdapter(Context c, String[] dataBody, String[] dataPublisher)
	{
		this.c = c;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		// TODO Auto-generated method stub
		if(convertView == null)
			convertView = inf.inflate(R.layout.mored_dashtim_list_items, parent, false);
