...
public class EterafMikonamBaseAdapter extends BaseAdapter {
	private Context c;
	private LayoutInflater inf;
	private String[] dataBody, dataPublisher;
	public EterafMikonamBaseAdapter(Context c, String[] dataBody, String[] dataPublisher)
	{
		this.c = c;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		// TODO Auto-generated method stub
		if(convertView == null)
			convertView = inf.inflate(R.layout.eteraf_mikonam_list_items, parent, false);
