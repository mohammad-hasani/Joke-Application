...
public class FakoFamilBaseAdapter extends BaseAdapter {
	private Context c;
	private LayoutInflater inf;
	private String[] dataBody, dataPublisher;
	public FakoFamilBaseAdapter(Context c, String[] dataBody, String[] dataPublisher)
	{
		this.c = c;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		// TODO Auto-generated method stub
		if(convertView == null)
			convertView = inf.inflate(R.layout.fako_famil_list_items, parent, false);
