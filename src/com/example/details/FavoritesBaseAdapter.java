...
public class FavoritesBaseAdapter extends BaseAdapter {
	...
	public FavoritesBaseAdapter(Context c, String[] dataBody, String[] dataPublisher)
	{
		this.c = c;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		// TODO Auto-generated method stub
		if(convertView == null)
			convertView = inf.inflate(R.layout.joke_list_items, parent, false);
		...
		chk1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				// TODO Auto-generated method stub
				if(isChecked)
					addToDB(body.getText().toString() , publisher.getText().toString());
				else
					removeFromDB(body.getText().toString(), publisher.getText().toString());
			}
		});
		chk1.setChecked(selectFromDB(body.getText().toString()));
		return convertView;
	}
	...
	void removeFromDB(String body, String publisher)
	{
        ...
        db.execSQL("delete from favorites where body like'"+body+"'");
		db.close();
	}
